...
HD_PWD='Z:/Desktop/EECE2323/lab2/lab2proj/lab2proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log palu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source palu_top.tcl
