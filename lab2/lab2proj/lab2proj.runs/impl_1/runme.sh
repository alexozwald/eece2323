...
HD_PWD='Z:/Desktop/EECE2323/lab2/lab2proj/lab2proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log palu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source palu_top.tcl -notrace
