...
HD_PWD='Z:/Desktop/EECE2323/lab4proj/lab4proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_regfile_vio_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_regfile_vio_top.tcl
