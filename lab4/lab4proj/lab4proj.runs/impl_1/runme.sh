...
HD_PWD='Z:/Desktop/EECE2323/lab4proj/lab4proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_regfile_vio_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_regfile_vio_top.tcl -notrace
