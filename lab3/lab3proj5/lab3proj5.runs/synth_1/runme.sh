...
HD_PWD='Z:/Desktop/EECE2323/lab3proj5/lab3proj5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eightbit_alu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eightbit_alu_top.tcl
