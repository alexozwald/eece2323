...
HD_PWD='Z:/Desktop/EECE2323/lab3proj5/lab3proj5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eightbit_alu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eightbit_alu_top.tcl -notrace
